...
export const TEMPLATE_SEEDS: TemplateSeed[] = [
  ...
  // ── BOOKING — New Link-Up (Owner) ──────────────────────────────────────────
  {
    ...
    body: "{{guestName}} linked up \"{{propertyTitle}}\" from {{startDate}} to {{endDate}}. Tap to review the request.",
  ...
  },
  {
    ...
    body: "🔔 inndos: {{guestName}} has requested a link-up for \"{{propertyTitle}}\" ({{startDate}} – {{endDate}}). Log in to confirm or decline: {{dashboardUrl}}",
    variables: BOOKING_VARS,
  },
  {
    ...
    body: "Hi {{ownerName}}, <strong>{{guestName}}</strong> has submitted a link-up request for <strong>{{propertyTitle}}</strong> from <strong>{{startDate}}</strong> to <strong>{{endDate}}</strong>. Log in to your dashboard to confirm or decline.",
  ...
  // ── BOOKING — New Link-Up (Admin) ──────────────────────────────────────────
  {
    ...
    body: "New link-up: {{guestName}} booked \"{{propertyTitle}}\" ({{startDate}} → {{endDate}}).",
    variables: BOOKING_VARS,
  },
  {
    ...
    body: "📋 inndos Admin: New link-up — {{guestName}} booked \"{{propertyTitle}}\" ({{startDate}} → {{endDate}}).",
    variables: BOOKING_VARS,
  },
  ...
  },
  {
    ...
    body: "🎉 inndos: Great news! Your link-up for \"{{propertyTitle}}\" ({{startDate}} – {{endDate}}) has been confirmed by the owner. View details: {{dashboardUrl}}",
    variables: BOOKING_VARS,
  },
  {
    ...
    body: "Hi {{guestName}}, great news! Your link-up request for <strong>{{propertyTitle}}</strong> from <strong>{{startDate}}</strong> to <strong>{{endDate}}</strong> has been <strong>confirmed</strong> by the owner.",
  ...
  },
  {
    ...
    body: "Hi {{guestName}}, we're sorry — your link-up request for <strong>{{propertyTitle}}</strong> from <strong>{{startDate}}</strong> to <strong>{{endDate}}</strong> was not approved this time. Don't worry, there are many great properties on inndos.",
  ...
  // ── BOOKING — Cancelled by Guest (Owner) ───────────────────────────────────
  {
    ...
    body: "{{guestName}} cancelled their link-up for \"{{propertyTitle}}\" ({{startDate}} → {{endDate}}).",
    variables: BOOKING_VARS,
  },
  {
    ...
    body: "inndos: {{guestName}} has cancelled their link-up request for \"{{propertyTitle}}\" ({{startDate}} – {{endDate}}). Your listing remains available.",
    variables: BOOKING_VARS,
  },
  ...
  },
  {
    ...
    body: "📋 inndos Admin: {{guestName}} cancelled their link-up for \"{{propertyTitle}}\" ({{startDate}} → {{endDate}}).",
    variables: BOOKING_VARS,
  },
