...
The PesaPal mode flag does not convert credentials between environments. Live mode must use live merchant credentials; a sandbox account can still produce sandbox-limit errors even when the application setting says live.
