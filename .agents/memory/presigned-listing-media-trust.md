...
**How to apply:** Any new route that attaches uploaded objects to listings must preserve owner-scoped paths, actual byte-size checks, media decoding/probing, and plan limits at the persistence boundary.